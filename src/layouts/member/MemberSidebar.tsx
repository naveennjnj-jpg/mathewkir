...
const MemberSidebar = ({
  ...
  const sidebarItems = [
    ...
    { title: "My Contributions", path: "/member/contributions", icon: Building2 },
    { title: "Payment Submission", path: "/member/payments", icon: Wallet },
    { title: "My Beneficiaries", path: "/member/beneficiaries", icon: FileText },
    // { title: "My Groups", path: "/member/groups", icon: Users },
    { title: "Settings", path: "/member/settings", icon: Settings },
  ];
