        ...
        <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
          <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
            ...
            >
              ...
              <svg
                className={`fill-current lg:hidden ${isSidebarOpen ? 'hidden' : 'block'}`}
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              {/* cross icon */}
              <svg
                className={`fill-current lg:hidden ${isSidebarOpen ? 'block' : 'hidden'}`}
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <div className="relative" ref={notificationRef}>
                ...
                {isNotificationsOpen && (
                  <div className="shadow-theme-lg dark:bg-gray-dark absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800">
                    ...
                    {notifications.length > 0 && (
                      // In treasurerHeader.tsx, update the "View All Notifications" link
                      <a
              ...
              >
                <span className="mr-3 h-11 w-11 overflow-hidden rounded-full">
                  {userData.avatar ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-r from-[#F2CA46] via-[#D4AF37] to-[#AA6C39] rounded-full flex items-center justify-center">
                ...
                <svg
                  className={`stroke-gray-500 dark:stroke-gray-400 transition-transform ${isProfileOpen ? 'rotate-180' : ''}`}
                  width="18"
                  height="20"
                  viewBox="0 0 18 20"
                  fill="none"
