...
const Contributions: React.FC = () => {
  ...
  const fetchContributions = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        setFilteredData(response.data.data.contributions);
      } else {
  ...
  const setMockData = () => {
    const mockContributions: Contribution[] = [
      {
        id: '1',
        eventName: 'Annual Community Fundraiser',
        amount: 100,
        date: '2026-07-15',
        paymentMethod: 'card',
        status: 'paid',
      ...
      {
        id: '2',
        eventName: 'Park Renovation Project',
        amount: 50,
        date: '2026-07-10',
      ...
      {
        id: '6',
        eventName: 'Youth Sports Program',
        amount: 60,
        date: '2026-06-15',
        paymentMethod: 'bank_transfer',
        status: 'paid',
      ...
      {
        id: '8',
        eventName: 'Senior Citizens Support',
        amount: 45,
        date: '2026-06-05',
        paymentMethod: 'card',
        status: 'overdue',
      ...
      {
        id: '9',
        eventName: 'Arts and Culture Festival',
        amount: 55,
        date: '2026-05-28',
        paymentMethod: 'mobile_money',
        status: 'paid',
      ...
      {
        id: '11',
        eventName: 'Back to School Drive',
        amount: 80,
        date: '2026-05-15',
        paymentMethod: 'card',
        status: 'pending',
    ...
    setFilteredData(mockContributions);
  };
