                ...
                <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
                  ...
                  <div className="max-w-full overflow-x-auto custom-scrollbar">
                    <div className="-ml-5 min-w-[650px] pl-2 xl:min-w-full">
                      <div className="-ml-5 h-full min-w-[650px] pl-2 xl:min-w-full" style={{ minHeight: '195px' }}>
                        {/* Chart placeholder - You can add your chart library here */}
                ...
                <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
                  <div className="shadow-default rounded-2xl bg-white px-5 pb-11 pt-5 dark:bg-gray-900 sm:px-6 sm:pt-6">
                    ...
                    <div className="relative max-h-[195px]">
                      <div className="h-full" style={{ minHeight: '229px' }}>
                        <div className="h-[229px] flex items-center justify-center text-gray-400">
                          Chart Component Here
                        </div>
                      </div>
                  ...
                  <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
                    <div>
                      ...
                      <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg">$20K</p>
                    </div>
              ...
              <div className="col-span-12">
                <div className="rounded-2xl border border-gray-200 bg-white px-5 pt-5 pb-5 sm:px-6 sm:pt-6 dark:border-gray-800 dark:bg-white/[0.03]">
                  <div className="mb-6 flex flex-col gap-5 sm:flex-row sm:justify-between">
                    ...
                    <div className="flex w-full items-start gap-3 sm:justify-end">
                      <div className="inline-flex w-fit items-center gap-0.5 rounded-lg bg-gray-100 p-0.5 dark:bg-gray-900">
                        <button className="text-theme-sm rounded-md px-3 py-2 font-medium shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800">
                          Overview
                        </button>
                        <button className="text-theme-sm rounded-md px-3 py-2 font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                          Sales
                        </button>
                        <button className="text-theme-sm rounded-md px-3 py-2 font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                          Revenue
                  ...
                  <div className="custom-scrollbar max-w-full overflow-x-auto">
                    <div className="-ml-4 min-w-[700px] pl-2" style={{ minHeight: '325px' }}>
              ...
              <div className="col-span-12 xl:col-span-5">
                <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                  ...
                  <div className="border-gary-200 my-6 overflow-hidden rounded-2xl border bg-gray-50 px-4 py-6 dark:border-gray-800 dark:bg-gray-900 sm:px-6">
                    <div className="h-[212px] flex items-center justify-center text-gray-400">
                      Map Component Here
                    </div>
                  </div>
                  <div className="space-y-5">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-full max-w-8 items-center rounded-full">
                          <img src="/images/country/country-01.svg" alt="usa" className="w-8 h-8" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-full max-w-8 items-center rounded-full">
                          <img src="/images/country/country-02.svg" alt="france" className="w-8 h-8" />
                        </div>
                        <div>
                    ...
                    <table className="min-w-full">
                      <thead>
                        <tr className="border-gray-100 border-y dark:border-gray-800">
                          <th className="py-3"><p className="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Products</p></th>
                          <th className="py-3"><p className="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Category</p></th>
                          <th className="py-3"><p className="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Price</p></th>
                          <th className="py-3"><p className="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Status</p></th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          <td className="py-3">
                            <div className="flex items-center">
                              <div className="flex items-center gap-3">
                                <div className="h-[50px] w-[50px] overflow-hidden rounded-md bg-gray-200"></div>
                                <div>
                          ...
                          <td className="py-3"><p className="text-gray-500 text-theme-sm dark:text-gray-400">Laptop</p></td>
                          <td className="py-3"><p className="text-gray-500 text-theme-sm dark:text-gray-400">$2399.00</p></td>
                          <td className="py-3">
                            <p className="rounded-full bg-success-50 px-2 py-0.5 text-theme-xs font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">Delivered</p>
                          </td>
                        </tr>
                        <tr>
                          <td className="py-3">
                          ...
                          <td className="py-3"><p className="text-gray-500 text-theme-sm dark:text-gray-400">Watch</p></td>
                          <td className="py-3"><p className="text-gray-500 text-theme-sm dark:text-gray-400">$879.00</p></td>
                          <td className="py-3">
                            <p className="rounded-full bg-warning-50 px-2 py-0.5 text-theme-xs font-medium text-warning-600 dark:bg-warning-500/15 dark:text-orange-400">Pending</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
